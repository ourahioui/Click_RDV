        ...
        <section className={styles.heroSection}>
          <Container>
            <Row className="align-items-center">
              ...
              <Col md={6}>
                <img src="https://placehold.co/500x400" alt="Doctor" className={`${styles.heroImage} img-fluid`} />
              </Col>
            </Row>
          </Container>
        </section>
                  ...
                  <Row>
                    <Col md={5}>
                      <InputGroup>
                        ...
                        <Form.Control placeholder="spécialité" className={styles.formInput} />
                      </InputGroup>
                    </Col>
                    <Col md={5}>
                      <InputGroup>
                        ...
                        <Form.Control placeholder="localisation" className={styles.formInput} />
                      </InputGroup>
                    </Col>
                    <Col md={2}>
                      <Button className={styles.searchButton}>Recherche</Button>
                    </Col>
                  </Row>
                </Form>
              </Col>
            ...
            <Row>
              <Col md={5}>
                <div className={styles.statsCard}>
                  <img src="https://placehold.co/400x300" alt="Doctor with patient" className="img-fluid" />
